...
create a folder for this course. Use a short expressive name like `DataEngineeringWearables`. Do not use spaces in file/folder names, see [good practices](https://brry.github.io/course/good-practice.html).

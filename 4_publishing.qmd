...
- In VScode, install the [quarto](https://marketplace.visualstudio.com/items?itemName=quarto.quarto) extension, create a `.qmd` file —
  for a template, copy content e.g. from the [quarto guide](https://quarto.org/docs/get-started/hello/vscode.html#render-and-preview)
...
- implement suggested changes in [4_practice.qmd](4_practice.qmd)
